...
public class ItemRepositoryTest {
	...
	// Used to control transactions - we will do this more elegantly with Spring
	// Transactions
	@Autowired
	...
	public void testFindByArtistdPositive() {
		...
		// TODO: Call the method to search by artist based on the artist variable
		// defined above.
		Collection<MusicItem> results = repo.findByArtistContaining(artist);
