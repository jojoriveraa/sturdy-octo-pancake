...
public class RestClient {
	...
	public static void main(String[] args) {
		...
		System.out.println("*** XML unmarshalling");
		
		rt.getMessageConverters().add(new MappingJackson2XmlHttpMessageConverter());
		httpEntity = new HttpEntity<MusicItem>(headers);
		foundEntity = rt.exchange(ID_URI, HttpMethod.GET, httpEntity, MusicItem.class, "2");
		System.out.println("Content type: " + foundEntity.getHeaders().getContentType());
		System.out.println("Status code: " + foundEntity.getStatusCode());
		System.out.println("Body: " + foundEntity.getBody());
		...
		System.out.println("*** View RAW data");
		
		HttpEntity<String> httpEntityString = new HttpEntity<String>(headers);
		ResponseEntity<String> foundEntityStr = rt.exchange(ID_URI, HttpMethod.GET, httpEntityString, String.class, "2");
		System.out.println("Content type: " + foundEntityStr.getHeaders().getContentType());
		System.out.println("Status code: " + foundEntityStr.getStatusCode());
		System.out.println("Body: " + foundEntityStr.getBody());
